...
> **Runs only when Phase 1 classified the scope as Main Domain
> scope**, immediately following Phase 1B. If the scope was
> classified as **Wildcard scope**, skip this phase entirely —
> Phase 1A is the complete path for wildcard scopes and this phase
> must not run.
